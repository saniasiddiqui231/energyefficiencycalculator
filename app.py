...
# wind turbine inputs
input_data_wt = pd.read_csv("./devices/wind_turbine_as/data/wind_turbine_input.csv")
...
# transformer inputs
input_data_tr=pd.read_csv('./devices/transformer/inputdata.csv')
...
# insulator inputs
input_data_in = pd.read_csv('./devices/insulator/data/input.csv')
